...
set /p PackageVersion="%ESC%[92mMvvmLight.OpenSilver version:%ESC%[0m "
...
md temp
@echo MvvmLight.OpenSilver %PackageVersion% (%currentdate% %currenttime%)> temp/Version.txt
...
echo. 
nuget.exe pack nuspec\MvvmLight.OpenSilver.nuspec -OutputDirectory "output/MvvmLight.OpenSilver" -Properties "PackageId=OpenSilver.MvvmLight;PackageVersion=%PackageVersion%;Configuration=Release"
